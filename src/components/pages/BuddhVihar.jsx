...
// import kopan from "../../assets/kopan.jpg";
// import ki from "../../assets/ki.jpg";
// import taksang from '../../assets/taksang.jpg';
// import xuan from "../../assets/xuan.jpg";
// import taung from "../../assets/taung.jpg";
// import punakha from "../../assets/punakha.jpg";
// import wat from "../../assets/wat.jpg";
// //import {fetchAllMonks} from "../services/monasteriesApi";
// //import Navbar from "../comman/Navbar";
// //import Footer from "../home/NewFoooter";

// // import phugtal from "../assets/phugtal.jpg";
// // import bugan from "../assets/bugan.jpg";
// // import kopan from "../asset/kopan.jpg";
// // import ki from "../assets/ki.jpg";
// // import taksang from "../assets/taksang.jpg";
// // import xuan from "../assets/xuan.jpg";
// // import taung from "../assets/taung.jpg";
...
// //         setError("Server error occurred while fetching monks");
// //       } finally {
// //         setLoading(false);
// //       }
// //     };
...
//       {/* ==================== HERO SECTION ==================== */}
//       <section className="relative bg-gradient-to-br from-red-400 via-red-400 to-red-400 overflow-hidden">
//         {/* Background Pattern */}
...
//             <span className="inline-block bg-red-100 text-red-400 px-4 py-2 rounded-full text-sm font-semibold mb-3">
//               🏛️ Sacred Places
//             </span>
...
//           {/* Featured Quote */}
//           <div className="mt-14 bg-gradient-to-r from-red-400 to-red-400 rounded-2xl p-6 md:p-10 text-center text-white relative overflow-hidden">
//             <div className="absolute inset-0 opacity-10">
...
function BuddhistMonasteries() {
  ...
  // States for API data (Monks & Monasteries)
  const [buddhistMonks, setBuddhistMonks] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch Monks
        const monksRes = await api.get("/api/monks");
        const monksData = monksRes.data;
        // Map backend fields to frontend expected fields if necessary
        // const mappedMonks = monksData.map(m => ({
        //   id: m.id,
        //   name: m.name,
        //   title: m.tradition || "Buddhist Master",
        //   period: `${m.birth_year || '?'} - ${m.death_year || 'Present'}`,
        //   short_desc: m.biography ? m.biography.substring(0, 150) + "..." : "No description available.",
        //   biography: m.biography,
        //   image_url: m.image_url,
        //   birth_place: m.nationality || "Unknown",
        ...
        const mappedMonks = monksData.map((m) => ({
          id: m.id,
          name: m.name,
          title: m.title || "Buddhist Master",
          period: m.period,
          short_desc: m.history
            ? m.history.substring(0, 150) + "..."
            : "No description available.",
          history: m.history,
          famous_quote: m.famous_quote,
          image_url: m.image_url,
          birth_place: m.birth_place || "Unknown",
          original_name: m.name,
        }));
        setBuddhistMonks(mappedMonks);

        // Fetch Monasteries
        const monasteriesRes = await api.get("/api/monasteries");
        const monasteriesData = monasteriesRes.data;
        const mappedMonasteries = monasteriesData.map((m) => ({
          id: m.id,
          name: m.name,
          altName: m.type || "Monastery",
          location: m.country,
          image: m.image_url,
          altitude: m.altitude || "Unknown",
          founded: m.founded_year || "Unknown",
          type: m.type,
          shortDesc: m.short_desc,
          history: m.history,
          highlights: [], // Highlights not in current DB schema
        }));
        setMonasteries(mappedMonasteries);
      } catch (err) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {!loading && !error && buddhistMonks.length === 0 && (
            <div className="flex flex-col items-center justify-center py-20 bg-gray-50 rounded-3xl">
              ...
              <p className="text-gray-600 text-center max-w-md">
                Abhi database mein koi Buddhist monk ka data nahi hai. Jaldi hi
                yahan mahaan Buddhist bhikshuk ki jaankari add ki jayegi.
              </p>
              <div className="mt-8 flex gap-4">
                <div className="bg-red-100 text-red-400 px-6 py-3 rounded-xl">
                  <span className="text-2xl">☸</span>
